...
@ccclass
@executeInEditMode
export class TurnPageComp extends cc.Component {
    ...
    /** 记录数据 */
    protected _data: TurnPageCompData = null;
    ...
    /** 初始化数据 */
    public initData(data: TurnPageCompData): void {
        this._data = data;
    }
    ...
    protected _caleMove(dPos: cc.Vec2): void {
        ...
        console.log("看看 --- ",
            this._moveDir.x.toFixed(2), this._moveDir.y.toFixed(2),
            this._linePos.x.toFixed(2), this._linePos.y.toFixed(2),
            this._backMask.getRoot().x.toFixed(2), this._backMask.getRoot().x.toFixed(2)
        );
