...
import MySpriteAssembler from "./MySpriteAssembler";
...
/** 自定义精灵组件渲染组件 */
@ccclass
export default class MySpriteRender extends CustomRender {
...
// @ts-ignore
cc.Assembler.register(MySpriteRender, MySpriteAssembler);