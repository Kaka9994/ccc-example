import CustomAssembler from "../custom/CustomAssembler";
import TurnPageRender from "./TurnPageRender";
...
export default class TurnPageAssembler extends CustomAssembler {
    ...
    public init(comp: TurnPageRender) {
        this._triangleNum = comp.triangleNum;
        super.init(comp);
    }
